...
/*!
	\param team_id an unsigned integer corresponding to the unique identifier assigned to the newly created team.
...
/*!
	\param team_id an unsigned integer corresponding to the unique identifier assigned to the team hosting the channel.
	\param channel_id an unsigned integer corresponding to the unique identifier assigned to the newly created channel.
...
/*!
	\param channel_id an unsigned integer corresponding to the unique identifier assigned to the channel hosting the thread.
	\param thread_id an unsigned integer corresponding to the unique identifier assigned to the newly created thread.
        \param user_id an unsigned integer corresponding to the unique identifier of the user posting the message.
...
/*!
	\param thread_id an unsigned integer corresponding to the unique identifier assigned to the thread hosting the message.
	\param user_id an unsigned integer corresponding to the unique identifier of the user posting the message.
...
/*!
	\param team_id an unsigned integer corresponding to the unique identifier assigned to the corresponding team.
	\param user_id an unsigned integer corresponding to the unique identifier of the user joining the team.
	\return On success, 1 is returned. On error, -1 is returned and errno is set appropriately 
*/
...
/*!
	\param team_id an unsigned integer corresponding to the unique identifier assigned to the corresponding team.
	\param user_id an unsigned integer corresponding to the unique identifier assigned to the user leaving the team.
	\return On success, 1 is returned. On error, -1 is returned and errno is set appropriately 
*/
...
/*!
	\param user_id an unsigned integer corresponding to the unique identifier assigned to the newly created user.
...
/*!
	\param user_id an unsigned integer corresponding to the unique id of the newly logged user.
	\return On success, 1 is returned. On error, -1 is returned and errno is set appropriately 
*/
...
/*!
	\param sender_id an unsigned integer corresponding to the unique id of the user sending the message.
	\param receiver_id an unsigned integer corresponding to the unique id of the user receiving the message.
	\param message a character pointer corresponding to the message's content.
	\return On success, 1 is returned. On error, -1 is returned and errno is set appropriately 
*/
